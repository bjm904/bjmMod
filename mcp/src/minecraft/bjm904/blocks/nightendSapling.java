...
{
    public static final String[] WOOD_TYPES = new String[] {"nightend"};
    ...
    public void growTree(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        else if (l == 3)
        {
            ...
            if (object == null)
            {
                j1 = 0;
                i1 = 0;
                object = new NightendGen(true, 90 + par5Random.nextInt(100), 0, 0, false);//TREE OPTION HERE____________________________
            }
        }
        else
        {
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.saplingIcon[i] = par1IconRegister.registerIcon(ModInfo.texture.toLowerCase() + ":" + WOOD_TYPES[i] + "Sapling");
        }
    }
}
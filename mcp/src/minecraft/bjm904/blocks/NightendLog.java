...
public class NightendLog extends BlockRotatedPillar
{
    ...
    public static final String[] woodType = new String[] {"nightend"};
    @SideOnly(Side.CLIENT)
    private Icon[] field_111052_c;
    @SideOnly(Side.CLIENT)
    private Icon[] tree_top;

    public NightendLog(int par1)
    {
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.field_111052_c[i] = par1IconRegister.registerIcon(ModInfo.texture.toLowerCase() + ":" + woodType[i] + "Log_side");
            this.tree_top[i] = par1IconRegister.registerIcon(ModInfo.texture.toLowerCase() + ":" + woodType[i] + "Log_top");
        }
    }

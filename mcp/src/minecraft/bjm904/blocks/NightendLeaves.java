...
{
    public static final String[] LEAF_TYPES = new String[] {"nightend"};
    public static final String[][] field_94396_b = new String[][] {{"nightendLeaves"}, {"nightendLeavesOpaque"}};
    ...
    public NightendLeaves(int par1)
    {
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        for (int i = 0; i < field_94396_b.length; ++i)
        {
            ...
            {
                this.iconArray[i][j] = par1IconRegister.registerIcon(ModInfo.texture.toLowerCase() + ":" + field_94396_b[i][j]);
            }
        }
    }

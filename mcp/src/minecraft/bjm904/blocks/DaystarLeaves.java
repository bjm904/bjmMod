...
public class DaystarLeaves extends BlockLeavesBase implements IShearable
{
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        for (int i = 0; i < field_94396_b.length; ++i)
        {
            ...
            {
                this.iconArray[i][j] = par1IconRegister.registerIcon(ModInfo.texture.toLowerCase() + ":daystar" + field_94396_b[i][j]);
            }
        }
    }

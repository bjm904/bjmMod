...
public class DaystarLog extends BlockRotatedPillar
{
    ...
    {
        return Blocks.daystarLog.blockID;
    }
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.field_111052_c[i] = par1IconRegister.registerIcon(ModInfo.texture.toLowerCase() + ":daystarLog" + woodType[i] + "_side");
            this.tree_top[i] = par1IconRegister.registerIcon(ModInfo.texture.toLowerCase() + ":daystarLog_top");
        }
    }

...
public class BloodBagWitherSkeleton extends Item {
public BloodBagWitherSkeleton(int id) {
super(id);
...
return Names.bloodBagWitherSkeleton_unlocalizedName[itemstack.getItemDamage()];
}

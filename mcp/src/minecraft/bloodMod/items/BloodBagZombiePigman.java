...
public class BloodBagZombiePigman extends Item {
public BloodBagZombiePigman(int id) {
super(id);
...
return Names.bloodBagZombiePigman_unlocalizedName[itemstack.getItemDamage()];
}

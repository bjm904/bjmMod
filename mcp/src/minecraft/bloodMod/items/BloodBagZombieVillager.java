...
public class BloodBagZombieVillager extends Item {
public BloodBagZombieVillager(int id) {
super(id);
...
return Names.bloodBagZombieVillager_unlocalizedName[itemstack.getItemDamage()];
}

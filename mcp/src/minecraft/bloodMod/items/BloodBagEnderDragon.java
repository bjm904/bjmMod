...
public class BloodBagEnderDragon extends Item {
public BloodBagEnderDragon(int id) {
super(id);
...
return Names.bloodBagEnderDragon_unlocalizedName[itemstack.getItemDamage()];
}

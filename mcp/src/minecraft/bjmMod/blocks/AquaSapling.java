...
import bjmMod.treeGen.AquaGen;
import bjmMod.treeGen.AquaGenForest;
import bjmMod.treeGen.AquaGenHuge;
import bjmMod.treeGen.AquaGenTaiga;
...
public class AquaSapling extends BlockFlower
{
    ...
    public void growTree(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        if (l == 1)
        {
            object = new AquaGenTaiga(true);
        }
        else if (l == 2)
        {
            object = new AquaGenForest(true);
        }
        else if (l == 3)
        {
            for (i1 = 0; i1 >= -1; --i1)
            {
                for (j1 = 0; j1 >= -1; --j1)
                {
                    ...
                    {
                        object = new AquaGenHuge(true, 10 + par5Random.nextInt(20), 3, 3);
                        flag = true;
                        break;
                    }
                }
            ...
            if (object == null)
            {
                j1 = 0;
                i1 = 0;
                object = new AquaGen(true, 4 + par5Random.nextInt(7), 3, 3, false);
            }
        }
        else
        {

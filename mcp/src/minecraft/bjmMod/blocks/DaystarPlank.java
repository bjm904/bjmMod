...
public class DaystarPlank extends Block
{
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.iconArray[i] = par1IconRegister.registerIcon(ModInfo.texture.toLowerCase() + ":daystarPlank" + woodType[i]);
        }
    }
}

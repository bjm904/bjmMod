...
public class AquaLog extends BlockRotatedPillar
{
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.field_111052_c[i] = par1IconRegister.registerIcon(ModInfo.texture.toLowerCase() + ":aquaLog" + woodType[i] + "_side");
            this.tree_top[i] = par1IconRegister.registerIcon(ModInfo.texture.toLowerCase() + ":aquaLog_top");
        }
    }

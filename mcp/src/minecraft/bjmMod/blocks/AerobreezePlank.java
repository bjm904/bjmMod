...
public class AerobreezePlank extends Block
{
    ...
    public AerobreezePlank(int par1)
    {
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.iconArray[i] = par1IconRegister.registerIcon(ModInfo.texture.toLowerCase() + ":aerobreezePlank" + woodType[i]);
        }
    }
}

...
public class AquaGenTaiga extends WorldGenerator
{
    public AquaGenTaiga(boolean par1)
    {
        super(par1);
    }
            ...
            else
            {
                ...
                if (isValidSoil && par4 < 256 - l - 1)
                {
                    ...
                    for (j2 = 0; j2 <= j1; ++j2)
                    {
                        ...
                        for (i3 = par3 - k2; i3 <= par3 + k2; ++i3)
                        {
                            ...
                            for (int l3 = par5 - k2; l3 <= par5 + k2; ++l3)
                            {
                                ...
                                {
                                    this.setBlockAndMetadata(par1World, i3, j3, l3, Blocks.aquaLeaves.blockID, 1);
                                }
                            }
                        }
                    ...
                    for (j3 = 0; j3 < l - j2; ++j3)
                    {
                        ...
                        {
                            this.setBlockAndMetadata(par1World, par3, par4 + j3, par5, Blocks.aquaLog.blockID, 1);
                        }
                    }
